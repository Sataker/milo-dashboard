      ...
      <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-100 dark:border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Mensajes de hoy</p>
          </div>
        </div>
        <span className="text-xs sm:text-sm text-green-600 dark:text-green-400 font-medium bg-green-50 dark:bg-green-900/30 px-2 sm:px-3 py-1 rounded-full flex items-center gap-1">
            ...
            leads.map((lead, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-3 sm:p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors cursor-pointer group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <span className="font-medium text-gray-900 dark:text-white text-sm truncate">{lead.name}</span>
                        <span 
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 line-clamp-1">{lead.last_message}</p>
                    ...
                    {/* Action */}
                    <ChevronRight className="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-primary-500 transition-colors flex-shrink-0 hidden sm:block" />
                  </div>
                </motion.div>
              )
            })
